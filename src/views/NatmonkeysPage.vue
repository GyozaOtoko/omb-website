                    ...
                    <div class="header-content col-md-12">
                        <div class="row fade-up" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="800" data-aos-once="true">
                            <div class="col-md-7 align-self-center">
                                ...
                                <div class="mt-4">
                                    <a href="https://magiceden.io/ordinals/marketplace/natmonkeys" target="_blank" class="btn btn-warning" role="button">Adopt a Natmonkey</a>
                                </div>
                            </div>
                            <div id="viewerWrapper" class="d-flex col-md-5" style="min-height: 400px;min-width: 400px; margin-top: 50px; cursor: pointer" @click="download">
                                <div id="natmonkeysviewer" style="position: relative;width: 100%;height: 100%;" v-html="htmlContent"></div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
                        <a href="https://ordinal-monkey-business.gitbook.io/natmonkeys" class="btn" style="color: #fff" target="_blank"><i class="icofont-diamond" style="vertical-align: text-top"></i> Traits & Rarities</a>
                    </div>
                </div>
            </div>
        </div>
        <Transition name="fade">
            <div id="modalWrapper" v-show="showModal" style="position: absolute;height: 100vh;width: 100vw;background-color:rgba(0,0,0, 0.5);top: 0;display: flex;justify-content: center;align-items: center" @click="showModal = false">
                <div id="modal">
